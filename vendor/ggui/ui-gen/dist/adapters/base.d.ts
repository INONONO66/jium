import { McpServerConfig, AgentDefinition } from '@anthropic-ai/claude-agent-sdk';
import { JsonObject } from '@ggui-ai/protocol';
import { ToolDefinition, ProviderName, AdapterMode, AdapterResult } from './types.js';
import 'zod';
 ...
 */
interface ClaudeSdkConfig extends AdapterConfig {
 ...
 */
type AnyAdapterConfig = AdapterConfig | ClaudeSdkConfig;
/**
 ...
 */
declare abstract class GeneratorAdapter {
    protected readonly config: AnyAdapterConfig;
    abstract readonly provider: ProviderName;
    abstract readonly mode: AdapterMode;
    abstract readonly displayName: string;
    constructor(config: AnyAdapterConfig);
    /**
 ...
 */
declare function hasCredentials(config: AdapterConfig, ...envVarNames: string[]): boolean;

export { type AdapterConfig, type AnyAdapterConfig, type ClaudeSdkConfig, type GenerateParams, GeneratorAdapter, hasCredentials };
