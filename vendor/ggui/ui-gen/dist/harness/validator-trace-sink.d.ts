 ...
 */
declare function setValidatorTraceSink(sink: ValidatorTraceSink | null): void;
/** Read the active sink. Mostly for tests. */
declare function getValidatorTraceSink(): ValidatorTraceSink | null;
/**
 ...
 * generation).
 */
declare function emitValidatorTraceEvent(event: ValidatorTraceEvent): void;
/**
 ...
 */
declare function truncateSourceForTrace(source: string): string;
/**
 * Crockford-style random ID. Same approach as the LLM trace sink —
 * dep-free for any runtime the harness might run in.
 */
declare function newValidatorTraceId(): string;

export { type ValidatorTraceEvent, type ValidatorTraceSink, emitValidatorTraceEvent, getValidatorTraceSink, newValidatorTraceId, setValidatorTraceSink, truncateSourceForTrace };
