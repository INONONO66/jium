...
// src/harness/hash.ts
function hashHarness(h) {
  return h.id;
}

// src/harness/llm-trace-sink.ts
var activeSink2 = null;
...
export { WORKFLOWS, applyLineRanges, computeHarnessId, computeHarnessName, createHarness, defaultApplyPatch, getLlmTraceSink, getValidatorTraceSink, hashClassification, hashHarness, pickWorkflow, runCheck, runHarness, runWorkflow, setLlmTraceSink, setValidatorTraceSink };
