...
declare const MAX_EVAL_ROUNDS_HARD_LIMIT = 10;
/** Default (soft) max rounds for the balanced strategy */
declare const DEFAULT_EVAL_MAX_ROUNDS = 10;
/**
...
export { DEFAULT_EVAL_MAX_ROUNDS, type DimensionScores, type EvaluationConfig, type EvaluationContext, type EvaluationIssue, type EvaluationResult, MAX_EVAL_ROUNDS_HARD_LIMIT, type QualityMetadata, StrategyName };
