import { LlmProvider, LlmRoute } from '@ggui-ai/protocol';
 ...
 */
type ProviderErrorKind = 'no-credentials' | 'unauthorized' | 'forbidden' | 'rate-limited' | 'server-error' | 'client-error' | 'network' | 'invalid-response' | 'aborted' | 'unknown';
 ...
 */
declare function makeProviderError(args: {
    readonly kind: ProviderErrorKind;
    readonly provider: LlmProvider;
    readonly message: string;
    readonly status?: number;
 ...
 */
declare function statusToErrorKind(status: number): ProviderErrorKind;
/**
 ...
 */
declare function defaultValidateConfig(provider: LlmProvider, request: Pick<ProviderRequest, 'apiKey' | 'route'>): ProviderValidation;

export { type ProviderAdapter, type ProviderError, type ProviderErrorKind, type ProviderRequest, type ProviderResponse, type ProviderResult, type ProviderValidation, defaultValidateConfig, makeProviderError, statusToErrorKind };
